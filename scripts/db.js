...
const navDb = {
  // 1. 여성
    woman: [
        ...
        {
        groups: [
            { category: '이너웨어', items: ['스포츠브라', '보더&언더웨어'] },
            { category: '패션잡화', items: ['양말', '슬라이드'] }
        ]
        },
        {
        category: '액세서리',
    ...
    acc: [
        ...
        {
        category: '액세서리',
        items: ['장갑', '모자', '헤어 액세서리', '헤어밴드']
        },
        {
        category: '도구',
        items: ['가방', '요가매트', '요가 소도구', '워터보틀']
        }
    ],
...
const woman_runningDB = [
    {
        num: 1,
        thum: 'images/item/5-1.jpg',
        item_name: '벤틸레이티드 패커블 러닝 재킷',
        item_price: '230,000원'
    },
    {
        num: 2,
        thum: 'images/item/5-2.jpg',
        item_name: '패스트 앤 프리 탱크탑 미디엄 서포트, B/C컵',
        item_price: '109,000원'
    },
    {
        num: 3,
        thum: 'images/item/5-3.jpg',
        item_name: '어댑티드 스테이트 트랙 재킷',
        item_price: '184,000원'
    },
    {
        num: 4,
        thum: 'images/item/5-4.jpg',
        item_name: '슬릭 퍼포레이티드 탱크탑',
        item_price: '109,000원'
    },
    {
        num: 5,
        thum: 'images/item/5-5.jpg',
...
const man_runningDB = [
    {
        num: 1,
        thum: 'images/item/5-6.jpg',
        item_name: '패스트 앤 프리 에어플로우 러닝 싱글릿',
        item_price: '125,000원'
    },
    {
        num: 2,
        thum: 'images/item/5-7.jpg',
        item_name: '패스트 앤 프리 에어플로우 러닝 쇼츠 6"',
        item_price: '138,000원'
    },
    {
        num: 3,
        thum: 'images/item/5-8.jpg',
        item_name: '맨즈 패스트 앤 프리 싱글릿 레이스 렝스',
        item_price: '109,000원'
    },
    {
        num: 4,
        thum: 'images/item/5-9.jpg',
        item_name: '패스트 앤 프리 라인드 러닝 쇼츠 5"',
        item_price: '100,000원'
    },
    {
        num: 5,
        thum: 'images/item/5-10.jpg',
        item_name: '패스트 앤 프리 라인드 러닝 쇼츠 5" 업데이트 디자인',
        item_price: '74,000원 ~ 93,000원'
    }
];
...
const womanDailyDb = [
    {
        num: 1,
        thum: 'images/item/7-1.jpg',
        item_name: '리틀 지지 티',
        item_price: '67,000원'
    },
    {
        num: 2,
        thum: 'images/item/7-2.jpg',
        item_name: '스쿠바 오버사이즈드 풀집 후디 와플',
        item_price: '198,000원'
    },
    {
    ...
    {
        num: 2,
        thum: 'images/item/7-4.jpg',
        item_name: '스쿠바 에볼브 클래식 풀집 후디',
        item_price: '184,000원'
    },
    {
        num: 4,
        thum: 'images/item/7-5.jpg',
        item_name: '테일러드 리조트 하이라이즈 트라우저 레귤러',
        item_price: '129,000원 ~ 184,000원'
    },
    {
        num: 6,
        thum: 'images/item/7-6.jpg',
